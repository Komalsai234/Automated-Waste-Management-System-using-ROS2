...
import numpy as np
import time
from big_bazu.waste_client import WasteClient
...
class TrajectoryPublisher(Node):
    ...
    def __init__(self):
        ...
        urdf_file = '/home/hp/ros2_ws/src/my_robot/urdf/big_bazu.urdf'
    ...
    def inverse_kinematics_solution(self, x, y, z, claw):
        ...
        if claw == "o":
            ...
            print("\nClaw Closed\n")
            self.goal_positions = list(np.append(angles, [-0.065, 0.065]))
        else:
...
def main(args=None):
    ...
    client = WasteClient()
    future = client.send_image('/home/hp/ros2_ws/src/my_robot/image/camera_image.png')
